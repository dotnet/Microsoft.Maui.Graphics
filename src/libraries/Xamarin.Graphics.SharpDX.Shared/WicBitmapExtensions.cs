...
{
    public static class WicBitmapExtensions
    {
#if !NETFX_CORE
        ...
        public static Bitmap LoadFromStream(Stream stream)
        {
            ...
            var bitmapSource = new BitmapSource(bitmapFrameDecode.NativePointer);
            return new Bitmap(DXGraphicsService.FactoryImaging, bitmapSource, BitmapCreateCacheOption.NoCache);
        }
#else
        public static Bitmap LoadFromStream(Stream stream)
        {
